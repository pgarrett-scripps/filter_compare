...
if st.button(label='Run'):
    ...
    for file in files:
        ...
        target_spectra = len({peptide_line.file_name for result in target_results for peptide_line in result.peptide_lines})
        ...
        decoy_spectra = len({peptide_line.file_name for result in decoy_results for peptide_line in result.peptide_lines})
    ...
    fig = px.bar(df, x="file", y=['target_protein_locuses', 'target_protein_groups', 'target_stripped_peptides',
                                  'target_charged_stripped_peptides', 'target_peptides', 'target_spectra'], barmode="group",
    ...
    fig = px.bar(df, x="file", y=['decoy_protein_locuses', 'decoy_protein_groups', 'decoy_stripped_peptides',
                                  'decoy_charged_stripped_peptides', 'decoy_peptides', 'decoy_spectra'], barmode="group",
